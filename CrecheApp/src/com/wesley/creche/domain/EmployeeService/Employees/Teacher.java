 ...
 */
@Entity
public class Teacher implements Serializable,Person,Employee_Interface {
    ...
    //a teacher must have at least 1 subject
    ...
    public String toString() {
        return "com.wesley.creche.domain.EmployeeService.Employees.Teacher[ id=" + id + " ]";
    }

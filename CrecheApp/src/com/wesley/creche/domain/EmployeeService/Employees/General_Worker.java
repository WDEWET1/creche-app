 ...
 */
@Entity
public class General_Worker implements Serializable,Person,Employee_Interface {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof General_Worker)) {
            return false;
        }
        General_Worker other = (General_Worker) object;
    ...
    public String toString() {
        return "com.wesley.creche.domain.EmployeeService.Employees.General_Worker[ id=" + id + " ]";
    }
